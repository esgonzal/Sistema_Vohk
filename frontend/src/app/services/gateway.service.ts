...
export class GatewayService {
  ...
  getGatewayListOfLock(userID: string, lockID: number): Observable<GatewayLockResponse> {
    ...
    let url = 'http://localhost:3000/api/vohk/gateway/getListLock';
