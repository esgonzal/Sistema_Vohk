            ...
            janus.attach(
              {
                ...
                onmessage: function(msg, jsep) {
                  ...
                  if (result !== null && result !== undefined) {
                    ...
                    // The plugin closed
                      ...
                      var peeraudioElement = document.getElementById("peeraudio");
                      peeraudioElement.parentNode.removeChild(peeraudioElement);
                      return;
                    }
                    // Any loss?
                ...
                */
                  if (document.getElementById('myaudio') === null) {
                    ...
                    audio.controls = true;
                    audio.muted = true;
                    audio.textContent = 'Your browser does not support audio tag';
                    document.getElementById('audioleft').appendChild(audio);
                  }
                  TalkRtcgw.attachMediaStream(document.getElementById("myaudio"), stream);
                ...
                */
                  if (document.getElementById('peeraudio') === null) {
                    var audios = document.getElementById('audios');
                    if (audios) {
                      audios.classList.remove('hide');
                      audios.style.display = 'block';
                    ...
                    audio.controls = true;
                    audio.textContent = 'Your browser does not support audio tag';
                    document.getElementById('audioright').appendChild(audio);
                    document.getElementById('peeraudio').addEventListener('playing', function() {
                      document.getElementById('peeraudio').classList.remove('hide');
                      document.getElementById('peeraudio').style.display = 'block';
                    });
                  }

                  TalkRtcgw.attachMediaStream(document.getElementById("peeraudio"), stream);
                  var audioTracks = stream.getAudioTracks();
                  if (audioTracks === null || audioTracks === undefined || audioTracks.length === 0) {
                  // $('#peeraudio').hide();
                    document.getElementById('peeraudio').style.display = 'none';
                  } else {
                  // $('#peeraudio').removeClass('hide').show();
                    var peeraudio = document.getElementById('peeraudio');
                    if (peeraudio) {
                      peeraudio.classList.remove('hide');
                      peeraudio.style.display = 'block';
                    }
                  }
                },
